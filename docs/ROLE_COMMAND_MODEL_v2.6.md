# Role-Based Medical Command Model V2.6

V2.6 keeps the prototype as a role-based medical command system and makes the medic workflow feel like a field notebook upgraded into a live command picture: sweep first, treatment first, full documentation later.
...
V2.6 makes the חוג"ד view the first place where paper visibly loses:
...
מ״פ רפואה commands medical resources directly. The V2.6 demo should make this feel like a company resource command center, not a larger platoon dashboard.
...
V2.6 does not include a generic stretcher-team request type; evacuation support is handled through medical evacuation coordination.
