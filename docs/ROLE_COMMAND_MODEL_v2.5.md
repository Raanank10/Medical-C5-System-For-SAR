# Role-Based Medical Command Model V2.5

V2.5 keeps the prototype as a role-based medical command system and makes the medic workflow action-first: lifesaving procedures before form fields, strong reversible MSTART inferences, supply-used confirmation, and field-mode UI.
...
מ״פ רפואה commands medical resources directly. The V2.5 demo should make this feel like a company resource command center, not a larger platoon dashboard.
...
V2.5 does not include a generic stretcher-team request type; evacuation support is handled through medical evacuation coordination.
