# C5 Sentinel-SAR — MVP Product & Technical Specification v1.2

v1.2 is the field-experiment hardening release. It keeps the repository in development mode while making the demo safer to test with medics and commanders: exportable experiment logs, assessment debt, countdown-based vitals counting, alert acknowledgment, MIST wording that matches the actual static demo, and production contracts for precomputed command/logistics read models.
