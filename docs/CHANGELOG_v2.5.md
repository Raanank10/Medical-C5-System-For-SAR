...
Demo V2.5 sharpens RESCUE as a notebook replacement: action-first MSTART capture, automatic medical inference, immediate supply confirmation, and clearer field-mode UX.

## V2.5 Action-First Sweep
