-- C5 Sentinel-SAR Demo Seed Data v0.6
...
insert into incidents (id, visual_id, t_zero, t_injury_default, location_name, address, incident_type, status, is_draft, opened_by)
values (
...
insert into supply_requests (id, incident_id, requester_id, supervisor_id, status, delivery_location_json, notes)
values (
...
values (
  ...
  'medic',
  'TOURNIQUET_APPLIED',
  '{"treatment_type":"TOURNIQUET","limb":"R-Leg","application_time":"demo-relative-27m","inventory_deductions":[{"sku":"TQ","quantity_change":-1}],"location_at_time":{"building":"15A","floor":"3","apartment":"7"}}'::jsonb,
  'device-cohen',
  'evt-demo-tq-001',
...
-- v0.6 Platoon Stock demo inventory
...
-- Demo request remains Medic -> PC. PC may aggregate later into PC -> Log-O request.
update supply_requests
set request_level = 'medic_to_pc',
    approved_by_pc = null
where id = '40000000-0000-0000-0000-000000000001';


-- v0.6 Demo Draft Incident Pending Approval
insert into incidents (
  id, visual_id, t_zero, t_injury_default, location_name, address, incident_type,
  status, is_draft, draft_created_by, metadata
)
values (
