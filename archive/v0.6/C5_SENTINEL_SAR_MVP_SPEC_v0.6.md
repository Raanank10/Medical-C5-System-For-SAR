# C5 Sentinel-SAR — MVP Product & Technical Specification v0.6
...
# Treatment Update Protocol v0.6
...
# v0.6 Corrections and Safety Updates
...
Realtime updates include `origin_device_id`.

When the backend publishes an update from `realtime_outbox`, clients compare the message `origin_device_id` to their own device ID.
...
# v0.6 Platoon Stock Logistics Layer
...
# v0.6 Draft Incident, Sync, Vitals, and KPI Updates
