...
for (const file of files) {
  ...
  assert(html.includes('Demo V2.996'), `${rel}: launcher label must be V2.996`);
  assert(html.includes('ROLE // V2.996'), `${rel}: role label must be V2.996`);
  ...
  console.log(`${rel}: V2.996 medic speed + CC hero static smoke passed`);
}
