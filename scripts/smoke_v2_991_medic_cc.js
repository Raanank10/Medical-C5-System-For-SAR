...
for (const file of files) {
  ...
  assert(html.includes('Demo V2.993'), `${rel}: launcher label must be V2.993`);
  assert(html.includes('ROLE // V2.993'), `${rel}: role label must be V2.993`);
  ...
  console.log(`${rel}: V2.993 medic speed + CC hero static smoke passed`);
}
