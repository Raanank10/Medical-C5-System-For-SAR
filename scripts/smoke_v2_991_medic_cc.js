...
for (const file of files) {
  ...
  assert(html.includes('Demo V2.9915'), `${rel}: launcher label must be V2.9915`);
  assert(html.includes('ROLE // V2.9915'), `${rel}: role label must be V2.9915`);
  ...
  console.log(`${rel}: V2.9915 medic speed + CC hero static smoke passed`);
}
