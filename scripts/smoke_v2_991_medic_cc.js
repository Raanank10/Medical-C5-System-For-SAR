...
for (const file of files) {
  ...
  assert(html.includes('Demo V2.994'), `${rel}: launcher label must be V2.994`);
  assert(html.includes('ROLE // V2.994'), `${rel}: role label must be V2.994`);
  ...
  console.log(`${rel}: V2.994 medic speed + CC hero static smoke passed`);
}
