...
for (const rel of files) {
  ...
  assert(html.includes("const APP_VERSION = '2.99.13';"), `${rel}: APP_VERSION must be 2.99.13`);
  assert(html.includes('Demo V2.9913'), `${rel}: launcher label must be Demo V2.9913`);
  assert(html.includes('ROLE // V2.9913'), `${rel}: role header must be V2.9913`);
  assert(html.includes('Role-Based Medical Command System V2.9913'), `${rel}: role strip must be V2.9913`);
  ...
  console.log(`${rel}: V2.9913 demo polish static smoke passed`);
}
