...
for (const file of files) {
  ...
  assert(html.includes('Demo V2.9911'), `${rel}: launcher version label must be V2.9911`);
  assert(html.includes('ROLE // V2.9911'), `${rel}: role header version label must be V2.9911`);
  assert(html.includes('Role-Based Medical Command System V2.9911'), `${rel}: role system strip must be V2.9911`);
