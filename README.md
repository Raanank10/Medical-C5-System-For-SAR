...
| Area | Status | Notes |
| --- | --- | --- |
| Field/command prototype | Active Demo V2.3 | `index.html` and `demo/rescue-app.html` |
| Product specification | Active V2.3 role-command addendum | `docs/ROLE_COMMAND_MODEL_v2.3.md`, `docs/ALERT_OWNERSHIP_v1.3.md`, `docs/C5_SENTINEL_SAR_MVP_SPEC_v1.2.md` |
...
- [Role-based medical command model V2.3](docs/ROLE_COMMAND_MODEL_v2.3.md)
- [Metrics dictionary](docs/METRICS_DICTIONARY.md)
- [Demo script](docs/PC_DEMO_SCRIPT.md)
- [V2.3 changelog](docs/CHANGELOG_v2.3.md)
